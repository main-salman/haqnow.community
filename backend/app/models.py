...
class ApiKey(Base):
    ...
    scopes: Mapped[str] = mapped_column(
        String(200), default="ingest,search,export,admin"
    )
...
class DocumentShare(Base):
    ...
    shared_with_email: Mapped[str | None] = mapped_column(
...
# OCR-extracted plain text for full-text search
